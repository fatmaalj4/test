...
public class MenuFenetre extends JMenuBar {
	...
	private static final String MENU_SIMULATION_MODIFICATION = "Modification";
	private static final String MENU_SIMULATION_SAVE = "Save";

	private static final String MENU_SIMULATION_ZOOM = "Zoom";
	private static final String MENU_SIMULATION_TRANSVERSER = "Transverser";
	...
	//Créer modification
	private void ajouterMenuModification() {
		JMenu menuModification = new JMenu(MENU_SIMULATION_MODIFICATION);
		JMenuItem menuTransverser = new JMenuItem(MENU_SIMULATION_TRANSVERSER);
		JMenuItem menuZoom = new JMenuItem(MENU_SIMULATION_ZOOM);
		menuModification.add(menuTransverser);
		menuModification.add(menuZoom);

		menuTransverser.addActionListener((ActionEvent e) -> {
			JOptionPane.showMessageDialog(null,
					"<html><p>Transverser quelque chose</p></html>");
		});
		menuZoom.addActionListener((ActionEvent e) -> {
			JOptionPane.showMessageDialog(null,
					"<html><p>Zoom qqch</p>");
		});
		add(menuModification);
	}
}
